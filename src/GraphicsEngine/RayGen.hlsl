...
// View and project only used in rasterization pipeline, but is included here for alignment
...
void RayGen() {
	...
	// Trace the ray
	// Traverses the acceleration structres and invokes hit or miss shaders depending on the traversal
	TraceRay(
